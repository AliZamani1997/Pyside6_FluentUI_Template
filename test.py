...
# Template for the button definition  
temp = """  
            FluIconButton{  
                iconSource:FluentIcons.name  
...
with open("text.txt",'w') as file:
    # Loop through each icon and format the template  
    for icon in icons: 
        file.write(temp.replace("name",icon) ) 
    # txt += temp.replace("name",icon)  

# Now txt contains the formatted button definitions  
print(txt)  