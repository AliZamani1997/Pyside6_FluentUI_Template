...
FluObject{
    ...
    FluPaneItemExpander{
        ...
        FluPaneItem{
            ...
            count: 99
            infoBadge:FluBadge{
                count: item_icons.count
            }
            title:"Icons"
            menuDelegate: paneItemMenu
            url:"qrc:/qml/page/T_Icons.qml"
            onTap:{
                item_icons.count = 0
                navigationView.push(url)
            }
        ...
        FluPaneItem{
            ...
            title:"Buttons"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/Button.png",recentlyUpdated:true,desc:"A control that responds to user input and raisesa Click event."})
        ...
        FluPaneItem{
            title:"Slider"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/Slider.png",recentlyUpdated:true,desc:"A control that lets the user select from a rangeof values by moving a Thumb control along atrack."})
        ...
        FluPaneItem{
            title:"CheckBox"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/Checkbox.png",recentlyUpdated:true,desc:"A control that a user can select or clear."})
    ...
    FluPaneItemExpander{
        ...
        FluPaneItem{
            title:"InfoBar"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/InfoBar.png",recentlyUpdated:true,desc:"An inline message to display app-wide statuschange information."})
        ...
        FluPaneItem{
            title:"StatusView"
            menuDelegate: paneItemMenu
            url:"qrc:/qml/page/T_StatusView.qml"
            onTap:{ navigationView.push(url) }
        }
        FluPaneItem{
            title:"Carousel"
        ...
        FluPaneItem{
            title:"StaggeredView"
            menuDelegate: paneItemMenu
            url:"qrc:/qml/page/T_StaggeredView.qml"
            onTap:{ navigationView.push(url) }
        }
        FluPaneItem{
            title:"Watermark"
    ...
    FluPaneItemExpander{
        ...
        FluPaneItem{
            title:"Pivot"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/Pivot.png",order:3,recentlyAdded:true,desc:"Presents information from different sources in atabbed view."})
        ...
        FluPaneItem{
            title:"TabView"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/TabView.png",order:1,recentlyAdded:true,desc:"A control that displays a collection of tabs thatcan be used to display several documents."})
        ...
        FluPaneItem{
            title:"TableView"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/DataGrid.png",order:4,recentlyAdded:true,desc:"The TableView control provides a flexible way to display a collection of data in rows and columns"})
        ...
        FluPaneItem{
            title:"FlipView"
            menuDelegate: paneItemMenu
            extra:({image:"qrc:/res/image/control/FlipView.png",order:2,recentlyAdded:true,desc:"Presents a collection of items that the user canflip through, one item at a time."})
    ...
    FluPaneItemExpander{
        ...
        FluPaneItem{
            ...
            menuDelegate: paneItemMenu
            url:"qrc:/qml/page/T_Screenshot.qml"
            onTap:{ navigationView.push(url) }
        }
        FluPaneItem{
            title:"Captcha"
